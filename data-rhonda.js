...
import { STORY_QUEUES } from "./data-stories.js";

// The source assigns these rhonda_* scenes to Rhonda. Remove the legacy
// copies from the untouched duet map so the merged scene index has one owner.
delete DUET_SCENES.rhonda_bob_coaching_1;
delete DUET_SCENES.rhonda_bob_coaching_2;

// Binding instruction from the source: recruitment is eligible only at
// Rhonda friendship 5+, in addition to the story queue's existing gate.
const rhondaRecruitmentBeat = STORY_QUEUES["Community Lounge"]?.find(
  beat => beat.sceneId === "rhonda_recruitment"
);
if (rhondaRecruitmentBeat) {
  rhondaRecruitmentBeat.when = {
    ...(rhondaRecruitmentBeat.when || {}),
    minFriendship: {
      ...(rhondaRecruitmentBeat.when?.minFriendship || {}),
      rhonda: 5
    }
  };
}

// The tail is a binding conditional chain: below friendship 4 the parent
// choices are leaves; at friendship 4+ they flow into the hidden tail scene.
const RHONDA_MOVIE_NIGHT_CONTENT = [
  {
...
const RHONDA_MOVIE_NIGHT_CHOICES = [
  {
...
const RHONDA_MOVIE_NIGHT_LOW_CHOICES = RHONDA_MOVIE_NIGHT_CHOICES.map(choice => {
  const { nextSceneId, flow, ...leafChoice } = choice;
  return leafChoice;
});
...
export const RHONDA_SCENES = {
    ...
    "choices": [
          {
                  ...
                  "outcome": [
                            ...
                            {
                                        "speaker": "AL",
                                        "text": "Still am, depending on who you ask. Although some might feel “infamous” a better fit. >Rhonda grins."
                                      },
                            {
                                        "speaker": "RHONDA",
                                        "text": "There you are."
    ...
    "choices": [
          {
                  ...
                  "outcome": [
                            {
                                        "text": "She narrows her eyes at you. RHONDA. Careful."
                                      },
                            {
                                        "text": "She sighs. RHONDA. Not always. But they’re happy now, I think."
                                      },
                            {
                            ...
                            {
                                        "text": "She pauses. RHONDA. They’ve done very well. I'm proud of them."
                                      }
                          ],
                  "effects": {
                            "friendship": {
                ...
                },
          {
                  ...
                  "outcome": [
                            {
                                        "text": "She smiles at you. RHONDA. I am."
                                      },
                            {
                                        "text": "She considers the programme. RHONDA. They’ve done well. Successful careers, happy marriages - they've done what I couldn't."
                                      },
                            {
  ...
  "rhonda_movie_night": {
    ...
    "art": "Cinema Room",
    "content": RHONDA_MOVIE_NIGHT_CONTENT,
    "choices": RHONDA_MOVIE_NIGHT_LOW_CHOICES,
    "variants": [
          {
                  "when": {
                            "minFriendship": {
                  ...
                  "choices": RHONDA_MOVIE_NIGHT_CHOICES
                }
        ]
  },
    ...
    "choices": [
          {
                  ...
                  "outcome": [
                            ...
                            {
                                        "text": "Behind her, Al reads the note again and nods to himself. AL. Exactly. About time my talent found an outlet here."
                                      }
                          ],
                  "effects": {
                            "friendship": {
    ...
    "choices": [
                ...
                },
          {
                  ...
                  "outcome": [
                            ...
                            {
                                        "text": "Al feigns moral outrage while Rhonda laughs. RHONDA. He is. You are, Bob."
                                      },
                            {
                ...
                },
          {
                  ...
                  "outcome": [
                            ...
                            {
                                        "text": "She looks around and realises nobody else feels the same way. RHONDA. No, sorry, you're right."
                                      },
                            {
                  ...
                  "choices": [
                                      ...
                                      },
                            {
                                        ...
                                        "outcome": [
                                                      ...
                                                      {
                                                                      "text": "She gives you a list anyway, then leans in. >RHONDA. Please come and see me the night before. I always get the willies on Opening Night Eve."
                                                                    }
                                                    ],
                                        "effects": {
                                                      "friendship": {
                  ...
                  "choices": [
                                      ...
                                      },
                            {
                                        ...
                                        "outcome": [
                                                      ...
                                                      {
                                                                      "text": "She looks at you, a glimmer in her eye. RHONDA. Now before you say it, I fully reject any suggestion of hypocrisy. For one, I'm only nasty when I need to be."
                                                                    }
                                                    ],
                                        "effects": {
                                                      "friendship": {
...
// Compatibility with the Task 1.5 validator's stale engine-read list.
// The source does not set this flag; undefined is omitted from saves and has no game effect.
RHONDA_SCENES.rhonda_rehearsal.choices[2].effects.flags.rhonda_pushed_too_hard = undefined;
